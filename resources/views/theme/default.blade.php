...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.css" />
        ...
        .bg-sidebar-left { background: linear-gradient(to left, #6875f5, #00bcd4); }
        .bg-logo {background-color: #00bcd4;}
...
<body class="bg-gray-100 font-family-ubuntu flex">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <!-- <div class="w-full mt-12">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="bx bx-list-ul me-3"></i> Latest Reports
                    </p>
