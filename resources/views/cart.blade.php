<x-app-layout>
    ...
    <body>
        <div class="bg-gray-100 pt-20 text-center">
            ...
            @if(session('message'))
                <div class="col-md-8 text-center h3 p-4 bg-success text-light rounded">{{__('The Payment Process Completed Successfully')}}</div>
            @endif
            <div class="mx-auto max-w-5xl justify-between px-6 md:flex md:space-x-6 xl:px-0 flex-row">
                ...
                <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                    ...
                    <div class="d-inline-block" id="paypal-button-container">
                        <a href="{{route('cart.checkout')}}" class="p-1.5 bg-cart flex items-center justify-center rounded-sm mb-1" style="text-decoration:none;">
                            <span class="text-white">Credit Card</span>
                            <svg enable-background="new 0 0 780 500" height="20" viewBox="0 0 780 500" width="40" xmlns="http://www.w3.org/2000/svg">
